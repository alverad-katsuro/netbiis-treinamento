...
public class ClienteDAO {
    ...
    public static Cliente findCliente_byEmail(String email) {
        EntityManagerFactory entityManagerFactory = App.getEntityManagerFactory();
        EntityManager entityManager = entityManagerFactory.createEntityManager();
		
		TypedQuery<Cliente> query = entityManager.createQuery("select c from Cliente c where clienteEmail = :clienteEmail", Cliente.class);
		query.setParameter("clienteEmail", email);
		
		return query.getSingleResult();
	}

    public static Cliente findCliente_byCPF(String cpf) {
        EntityManagerFactory entityManagerFactory = App.getEntityManagerFactory();
        EntityManager entityManager = entityManagerFactory.createEntityManager();
		
		TypedQuery<Cliente> query = entityManager.createQuery("select c from Cliente c where clienteCpf = :clienteCpf", Cliente.class);
		query.setParameter("clienteCpf", cpf);
