  ...
  <body>
    ...
    <div class="section">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" role="form" action="http://localhost:8080/LojaVirtual/curso" method="get">
              <div class="form-group">
                <div class="col-sm-2">
                  <label class="control-label">Informar o código:</label>
                </div>
                <div class="col-sm-10">
                  <input type="number" min="1" name="codigo" class="form-control" placeholder="Código do curso"
