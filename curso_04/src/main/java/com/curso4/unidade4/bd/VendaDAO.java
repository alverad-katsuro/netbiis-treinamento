...
public final class VendaDAO extends ConfiguracaoBD implements ICrud<Cliente_has_Curso> {

    @Override
    public boolean create(Cliente_has_Curso venda) throws SQLException {
        conectar();
    ...
    @Override
    public List<Cliente_has_Curso> read() throws SQLException {
        ...
        List<Cliente_has_Curso> vendas = new ArrayList<>();
        PreparedStatement pst = conexao.prepareStatement(comando_sql);
        ...
        try {
            while (rs.next()){
                ...
                vendas.add(new Cliente_has_Curso(cliente_id, curso_id, data));
            }
            desconectar();
            return vendas;
    ...
    @Override
    public boolean update(Cliente_has_Curso venda) throws SQLException {
        conectar();
    ...
    @Override
    public boolean delete(Cliente_has_Curso venda) throws SQLException {
        conectar();
