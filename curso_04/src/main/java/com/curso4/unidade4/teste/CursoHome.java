 ...
 * @see com.curso4.unidade4.teste.Curso
...
public class CursoHome {
	...
	public Curso findById(java.lang.Integer id) {
		...
		try {
			Curso instance = (Curso) sessionFactory.getCurrentSession().get("com.curso4.unidade4.teste.Curso", id);
			if (instance == null) {
	...
	public List findByExample(Curso instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.curso4.unidade4.teste.Curso")
