 ...
 * @see com.curso4.unidade4.teste.Cliente
 * @author Hibernate Tools
 */
public class ClienteHome {

	private static final Logger logger = Logger.getLogger(ClienteHome.class.getName());

	private final SessionFactory sessionFactory = getSessionFactory();
	
	public static void main(String[] args) {
        Cliente cliente2 = new Cliente("Alfredo2", "Gabriel", "amgabriel1@hotmail.com", "(91) 984487808", "000.000.000-00");
        ClienteHome clientedao = new ClienteHome();
	...
	public Cliente findById(java.lang.Integer id) {
		...
		try {
			Cliente instance = (Cliente) sessionFactory.getCurrentSession().get("com.curso4.unidade4.teste.Cliente",
					id);
			if (instance == null) {
	...
	public List findByExample(Cliente instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.curso4.unidade4.teste.Cliente")
